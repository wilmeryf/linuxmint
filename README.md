...
![Configuração de criação](Imagens/01-vm-criacao-configuracao.png)

![Criação de HD](Imagens/02-vm-criacao-hd.png)

![Armazenamento de HDs](Imagens/03-vm-armazenamento-hd.png)

### Gerenciamento de discos

![Discos no Linux](Imagens/04-linux-discos-listados.png)

![Opções de montagem de disco](Imagens/05-linux-opcoes-montagem-disco.png)

### Uso do sistema

![Versão do Linux](Imagens/06-linux-versao-sistema.png)

![Comando tree](Imagens/07-linux-tree.png)
